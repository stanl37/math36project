...
for KERNEL_TYPE in KERNEL_TYPES:
  list_of_lenia_lists.append(create_lenias(KERNEL_TYPE))
...
for idx, lenias in enumerate(list_of_lenia_lists):
  ...
  print(f"Kernel {idx}\trun({GENS})\tsize: {lenias[0].SIZE}.\ttime: {round(end-start, 4)}s")
